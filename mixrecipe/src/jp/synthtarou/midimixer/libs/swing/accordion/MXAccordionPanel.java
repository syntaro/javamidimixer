 ...
 */
public class MXAccordionPanel extends javax.swing.JPanel {

    MXListedContentsGroup _group = new MXListedContentsGroup();
    
    public void setGroupSameAs(MXListedContentsGroup group) {
        _group = group;
    }
    ...
    public MXAccordionPanel() {
        ...
        //overwrite
        _contentsList = new MXListedContents();
        jScrollPane1.setViewportView(_contentsList.getContentPane());
        setSelected(false);
    }
    ...
    MXListedContents _contentsList;
    boolean _accordionOpened = true;
    boolean _selected = false;
    
    public void setSelected(boolean selected) {
        _selected = selected;
        JComponent panel = _contentsList.getContentPane();
        setSelectedSub(panel, selected);
    }
    
    void setSelectedSub(JComponent panel, boolean selected) {
        panel.setEnabled(selected);
        if (panel instanceof Container) {
            Component[] list = ((Container)panel).getComponents();
            for (Component child : list) {
                if (child instanceof JComponent) {
                    setSelectedSub((JComponent)child, selected);
                }
            }
        }
    }
    ...
    public MXListedContents getListedContents() {
