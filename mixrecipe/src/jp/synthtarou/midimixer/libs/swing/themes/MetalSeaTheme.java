 ...
 * @author yaman
 */
public class MetalSeaTheme extends DefaultMetalTheme {

    public String getName() { return "Sea"; }
    ...
    private final ColorUIResource secondary3 = new ColorUIResource(15, 15, 60); //jPanel

    private final ColorUIResource black = new ColorUIResource(222, 222, 222);
    private final ColorUIResource white = new ColorUIResource(51, 51, 99); //buttonBorder
