 ...
 * @author yaman
 */
public class MetalForestTheme extends DefaultMetalTheme {
    ...
    private final ColorUIResource secondary3 = new ColorUIResource(60, 60, 15); //jPanel

    private final ColorUIResource black = new ColorUIResource(222, 222, 222);
    private final ColorUIResource white = new ColorUIResource(51, 99, 51); //buttonBorder
