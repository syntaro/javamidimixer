 ...
 * @author yaman
 */
public class MetalWineTheme extends DefaultMetalTheme {

    public String getName() { return "Wine"; }
    ...
    private final ColorUIResource secondary3 = new ColorUIResource(60, 15, 15); //jPanel

    private final ColorUIResource black = new ColorUIResource(222, 222, 222);
    private final ColorUIResource white = new ColorUIResource(99, 51, 51); //buttonBorder
