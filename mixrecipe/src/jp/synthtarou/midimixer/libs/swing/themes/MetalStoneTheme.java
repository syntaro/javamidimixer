...
public class MetalStoneTheme extends DefaultMetalTheme {
    ...
    private final ColorUIResource secondary3 = new ColorUIResource(60, 60, 60); //jPanel

    private final ColorUIResource black = new ColorUIResource(222, 222, 222);
    private final ColorUIResource white = new ColorUIResource(91, 91, 91); //buttonBorder
