...
public class VUIAccessor {
    ...
    protected VUIAccessor(JComponent component, int type) {
    ...
    public void copyVarFrom(VUIAccessor from) {
        synchronized (this) {
        ...
        new VUITask() {
            ...
            public Object run() {
                ...
                if (needFire != null) {
                    ...
                    internalToUI();
                    VUIAccessorEvent evt = new VUIAccessorEvent(_component, VUIAccessor.this);
