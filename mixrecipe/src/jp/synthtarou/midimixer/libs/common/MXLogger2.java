 ...
 */
public class MXLogger2 {
    static MXLogger2 _instance = new MXLogger2();
    
    public static void main(String[] args) {
        MXLogger2.getLogger(MXLogger2.class).warning("**ワーニング");
        MXLogger2.getLogger(MXLogger2.class).info("**インフォ");
        MXLogger2.getLogger(MXLogger2.class).severe("**エラー");
        Throwable e = new RuntimeException("runtime error");
        MXLogger2.getLogger(MXLogger2.class).log(Level.INFO, e.getMessage(), e);
    }
