 ...
 */
public class MAccessorDemo extends javax.swing.JPanel {

    public static void main(String[] args) {
        MAccessorDemo demo = new MAccessorDemo();
        MXUtil.showAsDialog(null, demo, "demo");
        System.exit(0);
    }

    class ViewModel implements MAccessorListener {

        MAccessor bindSpinner;
        MAccessor bindTextArea;
        MAccessor bindTextField;
        MAccessor bindLabel;
        MAccessor bindSlider;

        MAccessor[] bindTenkey;
        MAccessor bindBack;
        MAccessor bindCler;
        MAccessor bindTo100;
        ...
        public ViewModel() {
            bindSpinner = new MAccessor(jSpinner1, this);
            bindTextArea = new MAccessor(jTextArea1, this);
            bindTextField = new MAccessor(jTextField1, this);
            bindSlider = new MAccessor(jSlider1, this);
            bindLabel = new MAccessor(jLabel1);

            bindTenkey = new MAccessor[]{
                new MAccessor(jButton0),
                new MAccessor(jButton1),
                new MAccessor(jButton2),
                new MAccessor(jButton3),
                new MAccessor(jButton4),
                new MAccessor(jButton5),
                new MAccessor(jButton6),
                new MAccessor(jButton7),
                new MAccessor(jButton8),
                new MAccessor(jButton9)};

            bindBack = new MAccessor(jButtonBack);
            bindCler = new MAccessor(jButtonClear);
            bindTo100 = new MAccessor(jButtonto100);
        ...
        public void accessorValueChanged(MAccessorEvent evt) {
            ...
            if (evt.getAccessor() == bindSlider || evt.getAccessor() == bindSpinner) {
                if (evt.getAccessor() != bindSlider) {
                    bindSlider.set(evt.getAccessor().getAsInt());
                    bindLabel.set(evt.getAccessor().getAsText());
                }
                if (evt.getAccessor() != bindSpinner) {
                    bindSpinner.set(evt.getAccessor().getAsInt());
                    bindLabel.set(evt.getAccessor().getAsText());
                }
            } else {
                bindLabel.set(evt.getAccessor().getAsText());
