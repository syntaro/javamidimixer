 ...
 */
public class MAccessor {

    public static void main(String[] args) {
        MAccessorDemo.main(args);
    }
    ...
    protected ArrayList<MAccessorListener> _listListener = new ArrayList();

    protected MAccessor(JComponent component, int type) {
    ...
    public MAccessor(JComponent component, MAccessorListener listener) {
        this(component);
        addChangeListener(listener);
    }

    public MAccessor(JComponent component) {
        _component = component;
        if (component instanceof JLabel) {
            ...
            MXLogger2.getLogger(MAccessor.class).severe("Component " + component + " class = " + component.getClass() + " is not supported.");
    ...
    public void copyVarFrom(MAccessor from) {
        synchronized (this) {
        ...
        new MainThreadTask() {
            ...
            public Object runTask() {
                ...
                if (needFire != null) {
                    ...
                    internalToUI();
                    MAccessorEvent evt = new MAccessorEvent(_component, MAccessor.this);
                    for (MAccessorListener l : _listListener) {
                        l.accessorValueChanged(evt);
                    }
                }
                return NOTHING;
            }
    ...
    public String getCLipboardText() {
        ...
        try {
            ...
            MXLogger2.getLogger(MAccessor.class
    ...
    public synchronized void addChangeListener(MAccessorListener listener) {
        _listListener.add(listener);
    }

    public synchronized void removeChangeListener(MAccessorListener listener) {
