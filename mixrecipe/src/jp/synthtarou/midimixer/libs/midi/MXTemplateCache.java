        ...
        if (status >= 0x80 && status <= 0xef) {
            ...
            if (command == 0xB0) { //ControlChange
                if (_cacheControlChange[data1] == null) {
                    _cacheControlChange[data1] = newCanonicalDword(dword);
                }
                if (_cacheControlChange[data1].canReuseDword(dword)) {
                    return _cacheControlChange[data1];
                }
                else {
                    System.out.println("ERROR 1 " + _cacheControlChange[data1]);
                }
            }
            else {
