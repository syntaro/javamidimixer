...
public class CCRuleManager {
    ...
    final CCRuleForTag root;

    final CCRuleForTag moduleData;
    final CCRuleForTag moduleData_controlCangeDefault;
    final CCRuleForTag moduleData_exclusiveDefault;
    final CCRuleForTag moduleData_progDefault;
    final CCRuleForTag moduleData_rhythmDefault;

    final CCRuleForTag instrumentList;
    final CCRuleForTag instrumentList_map;
    final CCRuleForTag instrumentList_pc;
    final CCRuleForTag instrumentList_bank;

    final CCRuleForTag drumSetList;
    final CCRuleForTag drumSetList_map;
    final CCRuleForTag drumSetList_pc;
    final CCRuleForTag drumSetList_bank;
    final CCRuleForTag drumSetList_tone;

    final CCRuleForTag controlChangeMacroList;
    final CCRuleForTag controlChangeMacroList_folder;
    final CCRuleForTag controlChangeMacroList_folderlink;
    final CCRuleForTag controlChangeMacroList_ccm;
    final CCRuleForTag controlChangeMacroList_ccm_value;
    final CCRuleForTag controlChangeMacroList_ccm_value_entry;
    final CCRuleForTag controlChangeMacroList_ccm_gate;
    final CCRuleForTag controlChangeMacroList_ccm_gate_entry;
    final CCRuleForTag controlChangeMacroList_ccm_memo;
    final CCRuleForTag controlChangeMacroList_ccm_data;
    final CCRuleForTag controlChangeMacroList_ccmLink;
    final CCRuleForTag controlChangeMacroList_table;
    final CCRuleForTag controlChangeMacroList_table_entry;

    final CCRuleForTag templateList;
    final CCRuleForTag templateList_folder;
    final CCRuleForTag templateList_template;
    final CCRuleForTag templateList_template_memo;
    final CCRuleForTag templateList_template_cc;
    final CCRuleForTag templateList_template_pc;
    final CCRuleForTag templateList_template_comment;

    final CCRuleForTag defaultData;
    final CCRuleForTag defaultData_mark;
    final CCRuleForTag defaultData_track;
    final CCRuleForTag defaultData_track_mark;
    final CCRuleForTag defaultData_track_tempo;
    final CCRuleForTag defaultData_track_timeSignature;
    final CCRuleForTag defaultData_track_keySignature;
    final CCRuleForTag defaultData_track_CC;
    final CCRuleForTag defaultData_track_PC;
    final CCRuleForTag defaultData_track_Comment;
    final CCRuleForTag defaultData_track_Template;
    final CCRuleForTag defaultData_track_EOT;
    ...
    protected CCRuleManager() {
        ...
        defaultData_mark.setupAttributeMust("ID", CCValueRule.valueRulePlusMinus);
