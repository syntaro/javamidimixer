 ...
 */
public class MGStatusPanel2 extends javax.swing.JPanel implements CaptureCallback {
     ...
     */
    public MGStatusPanel2(MX32MixerProcess process, MGStatus status) {
    ...
    public void buildStatusFromPanelDrum() {
        ...
        try {
            ...
            MXFileLogger.getLogger(MGStatusPanel2.class).log(Level.WARNING, ex.getMessage(), ex);
    ...
    public void startEditTemplate() {
        ...
        item9.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                MGStatusPanel2.this.displayStatusToPanelSlider();
                displayStatusToPanelSlider();
                displayStatusToPanelDrum();
            }
        });
    ...
    public void startBrowseXML() {
        ...
        if (picker.getReturnStatus() == INavigator.RETURN_STATUS_APPROVED) {
            ...
            try {
                ...
                MXFileLogger.getLogger(MGStatusPanel2.class
