...
public class CXNode  {
    ...
    public final CCRuleForTag _tagRule;
    public final String _nodeName;
    public final CXNode _parent;
    public CXNode _ccmLinkTo;
    ...
    public void setFilePosition(int lineNumber, int columnNumber) {
