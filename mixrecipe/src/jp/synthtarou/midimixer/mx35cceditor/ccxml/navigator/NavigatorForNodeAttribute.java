...
import jp.synthtarou.midimixer.mx35cceditor.ccxml.CCRuleForAttribute;
import jp.synthtarou.midimixer.mx35cceditor.ccxml.CCRuleForTag;
 ...
 */
public class NavigatorForNodeAttribute extends javax.swing.JPanel implements INavigator<MXWrap<String>>,INavigatorValidator {
    ...
    public synchronized ParamsOfNavigator<MXWrap<String>> getParamsOfNavigator() {
        if (_params == null) {
            _params = new ParamsOfNavigator<MXWrap<String>>();
        }
        return _params;
    }
}
