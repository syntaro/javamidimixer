...
import jp.synthtarou.midimixer.mx35cceditor.prompt.CCTextPrompt;
import jp.synthtarou.midimixer.mx35cceditor.prompt.PromptForAttribute;
import jp.synthtarou.midimixer.mx35cceditor.prompt.ShrinkableComboBoxRenderer;
...
public class CCV520XMLEditorForTag extends javax.swing.JPanel {
    ...
    public void setTargetFile(CCXMLFile file) {
        ...
        _file = file;
        MXWrapList<CCXMLNode> model = new MXWrapList();

        jComboBox1.setRenderer(new ShrinkableComboBoxRenderer());
        for (CCXMLNode module : file.listModules()) {
    ...
    private void jButtonAddAttributeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddAttributeActionPerformed
        ...
        PromptForAttribute prompt = new PromptForAttribute(_selection, null, null);
        CCPromptUtil.showPrompt(this, prompt);
        MXWrap<String> result = prompt.getPromptResult();
        if (result != null) {
    ...
    private void jButtonEditAttributeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditAttributeActionPerformed
        ...
        PromptForAttribute prompt = new PromptForAttribute(_selection, name, value);
        CCPromptUtil.showPrompt(this, prompt);
        MXWrap<String> result = prompt.getPromptResult();
        if (result != null) {
            if (result.name == null || result.name.length() == 0) {
    ...
    MXWrapList<CCXMLNode> _warningListModel;

    public MXWrapList<CCXMLNode> createWarningListModel() {
        MXWrapList<CCXMLNode> ret = new MXWrapList<>();
