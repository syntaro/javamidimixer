...
public class NavigatorForNodeAttribute extends javax.swing.JPanel implements INavigator <MXNamedObject<String>> {
    ...
    MXNamedObjectList<String> _attrNameModel;

    protected void setAttrNameModel() {
        _attrNameModel = new MXNamedObjectList<>();
    ...
    MXNamedObjectList<String> _attrValueModel;

    protected void setAttrValueModel(String attrName) {
        _attrValueModel = new MXNamedObjectList<>();
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        MXNamedObject<String> obj = new MXNamedObject<>(getAttrName(), getAttrValue());
    ...
    @Override
    public boolean validateWithNavigator(MXNamedObject<String> result) {
        return true;
    }
    ...
    @Override
    public MXNamedObject<String> getReturnValue() {
        return _returnValue;
    }
    
    MXNamedObject<String> _returnValue;
