 ...
 */
package jp.synthtarou.cceditor.midi.message;
...
public class ScaledNumber {
    ...
    public ScaledNumber(int fromsetRoomCount, int tosetRoomCount) {
    ...
    public static void test(int rangeFrom, int rangeTo, boolean invert) {
        ...
        ScaledNumber exp = new ScaledNumber(rangeFrom, rangeTo);
        // １．分布を集計する
