...
import jp.synthtarou.midimixer.libs.domino.CCRuleAttributes;
import jp.synthtarou.midimixer.libs.domino.CCRuleElement;
 ...
 */
public class CCXMLAttributePrompt extends javax.swing.JPanel implements IInputPromptPanel<MXWrap<String>> {
    ...
    protected void setAttrNameModel() {
        ...
        CCRuleElement tag = _node.getTagRule();
        if (tag != null) {
            List<CCRuleAttributes> attrRules = tag.listAttributes();
            for (CCRuleAttributes attr : attrRules) {
    ...
    protected void setAttrValueModel(String attrName) {
        ...
        CCRuleElement tag = _node.getTagRule();
        if (tag != null) {
            CCRuleAttributes attr = tag.getAttribute(attrName);
            if (attr != null) {
    ...
    public boolean validatePromptResult() {
        ...
        if (_targetName != null && name != null && _targetName.equalsIgnoreCase(name) == false) {
            CCRuleElement tagRule = _node.getTagRule();
