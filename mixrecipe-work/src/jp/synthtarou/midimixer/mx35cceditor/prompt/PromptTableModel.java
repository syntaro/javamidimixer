...
public abstract class PromptTableModel extends AbstractTableModel {
    ...
    public abstract IPromptPanel getRowEditor(Component parent, int rowIndex);

    public abstract IInputPromptPanel getCellEditor(Component parent, int rowIndex, int cellIndex);
}
