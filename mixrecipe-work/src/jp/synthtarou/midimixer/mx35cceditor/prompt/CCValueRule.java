...
public class CCValueRule {
    ...
    public static CCValueRule valueRuleColorFormat = new CCValueRule(TYPE_CUSTOM) {
        public  boolean validateText(String text) {
            try {
                ...
                MXUtil.numberFromText("0x" + red, true);
                MXUtil.numberFromText("0x" + green, true);
                MXUtil.numberFromText("0x" + blue, true);
    ...
    public CCValueRule valueRuleForAttributeNames(CCXMLNode node) {
        ...
        CCRuleElement def = node.getTagRule();
        List<CCRuleAttributes> listDefAttr = def.listAttributes();
    ...
    public CCValueRule valueRuleForTagNames(CCXMLNode node) {
        ...
        CCRuleElement def = node.getTagRule();
        List<CCRuleElement> listDefTag = def.listChildTags();
    ...
    public CCValueRule valueRuleForAttributeValues(CCXMLNode node, String attributeName) {
        ...
        CCRuleElement def = node.getTagRule();
        CCRuleAttributes defAttr = def.getAttribute(attributeName);
